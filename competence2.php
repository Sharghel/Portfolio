                  ...
                  <div class="slider_banner">
                     ...
                     <div class="slide_cont">
                        <div class="slider_cont_inner">
                           <h3 class="display-1"style="">Répondre aux incidents et aux demandes d’assistance et d’évolution</h3>
                           <p><a style="text-decoration: none; color: white;" href="index.php">Accueil</a><i class="fa fa-angle-double-right pt-1 px-3"></i> Compétence 2</p>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-4 mt-5 mt-lg-0">
                  <div class="bg-primary mb-5 py-3">
                     ...
                     <div class="d-flex justify-content-between px-4">
                        <h6 class="text-white my-3">▸Traiter des demandes concernant les services réseau et système, applicatifs</h6>
                     </div>
                     <div class="d-flex justify-content-between px-4">
         ...
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-8">
                  ...
                  <!-- Travaux 7 -->
                  <div>
                     <a href="travail7.php" style="display:inline-block; vertical-align:top">
                        <div style="width:77px; height:77px;" class="btn-icon bg-danger mr-4">
                           <i class="fa fa-2x fa-briefcase text-white" style="padding:24px 0px 0px 24px"></i>
                        </div>
                     </a>
                     <div class="mt-n1" style="display:inline-block">
                        <h4>Travaux 7 : Mise à jour de fichier Excel</h4>
                        <p>
                           ▸Collecter, suivre et orienter des demandes <br>
                           ▸Traiter des demandes concernant les applications<br>
                        </p>
